...
public class Questionnaire2_Activity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        continue_Button.setOnClickListener(v ->
        {
            ...
            String industry =((RadioButton)findViewById(radio_group.getCheckedRadioButtonId())).getText().toString();
            user.put("industry",industry);

            //Change page
            Intent intent = new Intent(Questionnaire2_Activity.this, Questionnaire3_Activity.class);
